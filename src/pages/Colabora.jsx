...
const Colabora = () => {
  return (
    <article className="colabora-article">
      <section className="colabora-title">
      <h1>COLABORA</h1>
      ...
      <img src="./assets/socio.png" alt="" />
        <p>
          ...
          de ella.
          <br />
          ¿Qué significa ser socio/a? Por menos de 2€ al mes (20€ al año) puedes
          formar parte de la asociación, acudir a las reuniones y decidir sobre
          ...
          parte, no te preocupes, no es obligatoria la asistencia. Nos encantará
          tenerte en la asociación igualmente.
        </p>
      </section>
